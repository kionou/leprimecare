                               ...
                               <div class="contact-header mb-3 bg-gray-400 py-2 px-1">
                                ...
                                <div v-else class="row justify-content-center">
                                    <div class="col-xxl-12 col-xl-12">
                                        ...
                                        <div class="row">
                                            <div v-for="client in paginatedItems" :key="client.id" class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                                <div class="card custom-card ">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fw-semibold fs-18 mb-0 text-center">{{ client.client_name }}</p>    <br>
                                                        <span class="text-muted fs-15"> <i class="ri-map-pin-add-line"></i> {{ client.address || 'Unknown' }}</span>    <br>
                                                        <span class="text-muted fs-15"> <i class="ri-home-wifi-fill"></i> {{ client.state || 'Unknown'}}</span>    <br>
