            ...
            <ul class="main-menu">
              ...
              <li class="slide has-sub" v-if="loggedInUser.role_id === 2">
                ...
                <ul class="slide-menu child1">
                  ...
                  <li class="slide">
                    <router-link
                      to="/dashboard/school-level"
                      class="side-menu__item"
                      >School levels</router-link
                    >
                  </li>

                  <li class="slide">
                    <router-link
                      to="/dashboard/means-transportations"
                      class="side-menu__item"
                      >Means of transportations</router-link
                    >
                  </li>
                  <li class="slide">
                    <router-link
                      to="/dashboard/driving-issue-state"
                      class="side-menu__item"
                      >Driving issues states</router-link
                    >
                  </li>

                  <li class="slide">
                    <router-link
                      to="/dashboard/duties-services"
                      class="side-menu__item"
                      >Duties</router-link
                    >
                  </li>
