                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <router-link to="/" class="header-logo">
                                <img src="@/assets/img/primecare.png" alt="logo" class="desktop-logo">
                                <img src="@/assets/img/primecare.png" alt="logo" class="toggle-logo">
                                <img src="@/assets/img/primecare.png" alt="logo" class="desktop-dark">
                                <img src="@/assets/img/primecare.png" alt="logo" class="toggle-dark">
                                <img src="@/assets/img/primecare.png" alt="logo" class="desktop-white">
                                <img src="@/assets/img/primecare.png" alt="logo" class="toggle-white">
                            </router-link>
                        </div>
                    </div>
                    <!-- End::header-element -->
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            <div class="d-flex align-items-center" v-if="loggedInUser">
                                ...
                                <div class="d-sm-block d-none" >
                                    <p class="fw-semibold mb-0 lh-1">{{ loggedInUser.prenom  }} {{ loggedInUser.nom  }}</p>
