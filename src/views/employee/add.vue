...
reason:{},
 ...
 other_skills:{},
   ...
   clearErrorRef(index, field) {
     ...
     swaaa(){
       Swal.fire({
Title: "Employee has been successfully created",
Text: "The employee has been successfully added to the system. A follow-up will be made after processing. Thank you.",
