        ...
        <div class="d-flex mt-sm-0 mt-2 align-items-center">
          <div class="input-group">
            <input
              ...
              placeholder="Search user managment"
    ...
    <div class="col-xl-12">
      <div class="card custom-card">
        <div class="card-header justify-content-between">
          <div class="card-title">Users Managments list</div>
        </div>
        <div class="card-body">
                ...
                <tr v-for="(data, index) in filteredUsers" :key="data.id">
                  ...
                  <td>
                    <div class="d-flex align-items-center fw-semibold">
                      <span class="avatar avatar-sm me-2 avatar-rounded">
                        <img
                          v-if="data.profile === null"
                          src="@/assets/img/client.png"
                          alt="img"
                        />
                        <img v-else :src="data.profile" alt="img" /> </span
                      >{{ data.Prenoms }} {{ data.Nom }}
                    </div>
                  </td>

                  <td>
                    <span v-if="data.roles.length !== 0" class="">{{
                      data.roles[0].name
                    }}</span>
                  </td>
                  ...
                  <td>
                    <div class="hstack gap-2 fs-15">
                      <button
                        disabled
                        class="btn btn-icon btn-wave waves-effect waves btn-sm btn-primary"
                        data-bs-toggle="modal"
